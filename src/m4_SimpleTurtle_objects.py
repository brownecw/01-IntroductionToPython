...
#
###############################################################################
speedy_boi = rg.SimpleTurtle('turtle')
speedy_boi.pen = rg.Pen('blue',14)
speedy_boi.speed = 8
speedy_boi.backward(100)
speedy_boi.left(90)
speedy_boi.forward(100)
speedy_boi.right(90)
speedy_boi.forward(200)
speedy_boi.right(90)
speedy_boi.forward(200)
speedy_boi.right(90)
speedy_boi.forward(200)
